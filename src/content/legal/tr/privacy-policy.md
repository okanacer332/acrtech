...
## Site Yardımcı Programları (Çerezler)

Kullanıcının sitenin bazı bölümlerinden yararlanabilmesi için yardımcı programlar kullanılması gerekebilir. Bu bölümlerden yararlanıldığı takdirde, yararlanma biçim ve kapsamıyla ilgili veriler, site veritabanına kaydedilebilir. Keza bölümlerden daha kolay yararlanabilmeniz için bazı “çerez”lerden yararlanabilir, bunlar vasıtasıyla kullanıcıya bazı bilgiler gönderebiliriz. Kişisel verilerinizle ilgili olarak verdiğiniz izin, size hizmet vermek; hizmetlerimizin, üyelerin, üçüncü şahısların tanıtım faaliyetleri; hukuki gereklilikler vb. hallerde kullanma iznini de içermektedir.
...
Site Sahibi, kullanıcı tarafından verilmiş olan kişisel verileri, Siteye erişimin sağlanması, üye girişi, Site güvenliğinin temin edilmesi, kullanıcı alışkanlık, beğeni ve tercihlerinin analizi, istatistik oluşturulması, iletişim, pazarlama, duyuru yapılması gibi amaçlar veya kullanıcının açık rızasının alındığı sair amaçlarla; mevzuata ve Kişisel Veri Politikası’na uygun olarak kullanabilir, işleyebilir, saklayabilir, yurt içindeki veya dışındaki üçüncü şahıslarla bu amaçlar doğrultusunda paylaşabilir, Acrtech’in faaliyet alanıyla ilgili olarak reklam, pazarlama, bildirim ve benzeri faaliyetler kapsamında kullanılabilir, veri tabanlarında tasnif edip saklayabilir, veri tabanındaki verilerden yararlanabilir. Site Sahibi bu kapsamda, site aktivite bilgilerinden, erişim araçları ve browser bilgilerinden de yararlanma hakkına sahiptir.
...
**İletişim:** www.acrtech.com web sitesinin gizlilik koşullarına ilişkin sorularınız için `info@acrtech.com` adresine yazarak daha fazla bilgi alabilirsiniz.